...
func GetServer() ServerConfig {
	...
	sName, _ := parser.QueryToString("data.results.[7].serviceName")
	host, _ := parser.QueryToString("data.results.[7].serviceHost")
	sPort, _ := parser.QueryToString("data.results.[7].servicePort")
