...
func GetServer() ServerConfig {
	...
	sName, _ := parser.QueryToString("data.results.[6].serviceName")
	host, _ := parser.QueryToString("data.results.[6].serviceHost")
	sPort, _ := parser.QueryToString("data.results.[6].servicePort")
