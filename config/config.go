...
func GetServer() ServerConfig {
	...
	sName, _ := parser.QueryToString("data.results.[4].serviceName")
	host, _ := parser.QueryToString("data.results.[4].serviceHost")
	sPort, _ := parser.QueryToString("data.results.[4].servicePort")
